...
namespace eLiDAR.ViewModels
{
    ...
    public class DemoAutoCompletePageViewModel : BaseViewModel, IGalleryPickerResultListener
    {
        ...
        private void OnAutocompleteTextChanged(TextChangedEventArgs eventArgs)
        {
            ...
            IsSearching = true;
            _ = Task.Delay(2000).ContinueWith(delegate
              {
                  //get something from API
                  var newResult = new List<IAutoDropItem>
                  {
                      new YourClass("New Item 1", "New Item - DC Universe", "dc"),
                      new YourClass("New Item 2", "New Item - DC Universe", "dc"),
                      new YourClass("New Item 3", "New Item - DC Universe", "dc"),
                      new YourClass("New Item 4", "New Item - DC Universe", "dc"),
                      new YourClass("New Item 5", "New Item - DC Universe", "dc")
                  };
